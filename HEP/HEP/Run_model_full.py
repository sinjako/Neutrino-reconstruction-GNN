...
if __name__ == '__main__':
    ...
    model =dynedge(c=3,k=[8,8,8,8]).to(device)
    modelinfo="dynedge_c=3,k=8_8_8_8_full_lr1_upgrade" # DO NOT USE PARENTHESIS LINUX NO LIKE
    ...
    graph_job=4
    train_batches=5248 ## THESE ARE GAINED FROM count_batches.py,batchsize 1000= 4800 for normal, 480 for upgrade
    val_batches=480## THESE ARE GAINED FROM count_batches.py, batchsize 1000= 464 for normal, 480 for upgrade
