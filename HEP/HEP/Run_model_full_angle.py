...
if __name__ == '__main__':
    ...
    model =dynedge(c=3,k=[8,8,8,8],mode='angle').to(device)
    modelinfo="dynedge_c=3,k=8_8_8_8_full_angle_lr1" # DO NOT USE PARENTHESIS LINUX NO LIKE
    # model=simpedge().to(device)
    # modelinfo="simpedge"
    
    optimizer = torch.optim.Adam(model.parameters(), lr=1*1e-3, eps= 1e-3)
    ...
    graph_job=4
    train_batches=2400 ## THESE ARE GAINED FROM count_batches.py
    val_batches=232## THESE ARE GAINED FROM count_batches.py
