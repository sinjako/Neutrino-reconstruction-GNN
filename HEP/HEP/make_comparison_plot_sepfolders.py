...
# SECOND AND THIRD PLOT MEDIAN AND WIDTH OF IQR
...
###############################################
    ...
    ##### MAKING THIRD PLOT WIDTH OF IQR
    fig7=plt.figure()
    ...
    ###### MAKING FOURTH PLOT  ENERGY HISTOGRAM
    fig8=plt.figure()
    host = plt.subplot2grid((3,3),(0,0),colspan=3,rowspan=3)
    ...
    percentile=99
    # print ((len(residlist[0])))
    rmax=np.percentile(residlist[0],percentile)
    host.hist(residlist,num_bins,label=labels,histtype='step',range=(0,rmax),align="left")
...
paths.append("D:\Schoolwork\Masters\Script\Savefolder\\29-06-2021-09-40-14-dynedgeEdgepool(c=3)")
model_name.append("edgepool2")

paths.append("D:\Schoolwork\Masters\Script\Savefolder\\28-06-2021-09-56-25-dynedgeEdgepool(c=1)")
model_name.append("edgepool_c=1")

# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\02-06-2021-14-51-42-dynedgegauss(mode='gauss')")
# model_name.append("dynedge_gauss")
# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\09-06-2021-04-46-48-dynedgegauss_edgepool(mode='gauss')")
# model_name.append("Dynedge_gauss_edgepool")


# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\23-06-2021-14-50-50-dynedgeEdgepool(c=2)")
# model_name.append("Dynedge_edgepool_c=2")
# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\01-06-2021-03-12-26-dynedgepool1")
# model_name.append("Edgepool")

# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\09-06-2021-06-15-46-dynedgegauss_edgepool_3edgeconv")
# model_name.append("edgepool_3edgeconv_gauss")



# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\09-06-2021-06-47-12-dynedgeEdgepool_3edgeconv")
# model_name.append("Edgepool_3edgeconv")

# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\02-06-2021-07-38-43-dynedgegauss(mode='gauss')")
# model_name.append("dynedge_gauss")
# paths.append("D:\Schoolwork\Masters\Script\Savefolder\\02-06-2021-07-38-43-dynedgegauss(mode='gauss')")
# model_name.append("gauss")
...
if figname != "":
    ...
    for i in model_name:
        os.makedirs(dirstring+i)
        for j in model_name:
            if i!=j:
                os.makedirs(dirstring+i+"//"+j)
    count=0
    pair=0
    totplots=5
    for fig in my_cool_figures:
        ...
        firstsave=newmodels[pair][0]
        secondsave=newmodels[pair][1]
        if count==1:
            currstring="Error_%s_%s"%(firstsave,secondsave)
            
            fig.savefig(dirstring+firstsave+"//"+currstring)
            fig.savefig(dirstring+secondsave+"//"+currstring)
            
            fig.savefig(dirstring+firstsave+"//"+secondsave+"//"+currstring)
            fig.savefig(dirstring+secondsave+"//"+firstsave+"//"+currstring)
        if count==2:
            currstring="Error_median_%s_%s"%(firstsave,secondsave)
            ...
            fig.savefig(dirstring+secondsave+"//"+firstsave+"//"+currstring)
        if count==3:
            currstring="Error_width__%s_%s"%(firstsave,secondsave)
            ...
            fig.savefig(dirstring+secondsave+"//"+firstsave+"//"+currstring)
        if count==4:
            currstring="Energy_distr__%s_%s"%(firstsave,secondsave)
            ...
            fig.savefig(dirstring+secondsave+"//"+firstsave+"//"+currstring)
        if count==5:
            currstring="resid_distr__%s_%s"%(firstsave,secondsave)
            fig.savefig(dirstring+firstsave+"//"+currstring)
            fig.savefig(dirstring+secondsave+"//"+currstring)
